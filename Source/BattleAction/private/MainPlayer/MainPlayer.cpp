...
void AMainPlayer::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	enhancedInputComponent->BindAction(m_InputMappingConfigs["Charging_OnGround"].inputActions["Charging_ComboDashAttack_OnGround"],
		ETriggerEvent::Triggered, skillComponent, &UMainPlayerSkillComponent::Charging_ComboDashAttack_OnGround);
...
void AMainPlayer::printLog()
{
	...
	GEngine->AddOnScreenDebugMessage(3, 0.1f, FColor::Green, FString::Printf(TEXT("Velocity Length(speed) : %f"), GetCurSpeed()));
